        ...
        <div class="row">
            <div class="col-lg-2 col-6">
                <a href="/admin/buku" class="small-box bg-gradient-navy">
                    <div class="inner">
                        <h3>@empty($book)@else {{$book}}@endempty</h3>
                        <p>Buku</p>
                    </div>
            ...
            <div class="col-lg-2 col-6">
                ...
                <div class="inner">
                    <h3>@empty($vid)@else {{$vid}}@endempty</h3>
                    <p>Video</p>
                </div>
            ...
            <div class="col-lg-2 col-6">
                <a href="/admin/sekolah" class="small-box bg-gradient-olive">
                    <div class="inner">
                        <h3>@empty($school)@else {{$school}}@endempty</h3>
                        <p>Sekolah</p>
                    </div>
            ...
            <div class="col-lg-2 col-6">
                <a href="/admin/user" class="small-box bg-gradient-secondary">
                    <div class="inner">
                        <h3>@forelse($user as $b){{$b->totidu}}@empty @endforelse</h3>
                        <p>User</p>
                    </div>
